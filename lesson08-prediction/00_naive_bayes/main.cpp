...
int main() {
  ...
  std::string root_dir = "/home/yao/workspace/path_planning/lesson08-prediction/00_naive_bayes/";
  vector< vector<double> > X_train = Load_State(root_dir + "support/nd013_pred_data/train_states.txt");
  vector< vector<double> > X_test  = Load_State(root_dir + "support/nd013_pred_data/test_states.txt");
  vector< string > Y_train = Load_Label(root_dir + "support/nd013_pred_data/train_labels.txt");
  vector< string > Y_test  = Load_Label(root_dir + "support/nd013_pred_data/test_labels.txt");
